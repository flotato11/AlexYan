...
function amountscrolled(){
  ...
  var c7h = $('.container7').height() /*camps*/
  ...
  var c3p = c1h + c2h
  var c7p = c1h + c2h + c3h
  var c4p = c1h + c2h + c3h + c7h
  var c5p = c1h + c2h + c3h + c7h + c4h
  var c6p = c1h + c2h + c3h + c7h + c4h + c5h
  ...
  var c7s = Math.floor((scrollTop-c7p)/(c7l) * 1000) + 915
  ...
  $('.project1header').css({ 'opacity' : Math.min(-4 + c3s/170, 1)});

  $('.project1headertopic').css({ 'right' : Math.min(-13 + c3s/40, 11) + "vw"});
  $('.project1headertopic').css({ 'opacity' : Math.min(-4 + c3s/170, 1)});

  $('.flotato').children('.vertical-line').css({ 'height' : Math.min(-180 + c3s/4, 58) + "vh" });
  $('.flotatocontent').css({ 'opacity' : Math.min(-5.5 + c3s/150, 1) });

  $('.project1description').css({ 'opacity' : Math.min(-4 + c3s/170, 1) });

  /*project 2*/
  $('.project2header').css({ 'left' : Math.max(54 - c3s/40, 19) + "vw"});
  $('.project2header').css({ 'opacity' : Math.min(-6.8 + c3s/170, 1)});

  $('.project2headertopic').css({ 'left' : Math.min(-29 + c3s/40, 5) + "vw"});
  $('.project2headertopic').css({ 'opacity' : Math.min(-6.8 + c3s/170, 1)});

  $('.seeingthings').children('.vertical-line').css({ 'height' : Math.min(-293 + c3s/4, 58) + "vh" });
  $('.seeingthingscontent').css({ 'opacity' : Math.min(-8.2 + c3s/150, 1) });

  $('.project2description').css({ 'opacity' : Math.min(-6.8 + c3s/170, 1) });

  /*project 3*/
  $('.project3header').css({ 'left' : Math.min(-41 + c3s/40, 5) + "vw"});
  $('.project3header').css({ 'opacity' : Math.min(-9.3 + c3s/170, 1)});

  $('.project3headertopic').css({ 'left' : Math.max(102 - c3s/40, 56) + "vw"});
  $('.project3headertopic').css({ 'opacity' : Math.min(-9.3 + c3s/170, 1)});

  $('.microbio').children('.vertical-line').css({ 'height' : Math.min(-408 + c3s/4, 50) + "vh" });
  $('.microbiocontent').css({ 'opacity' : Math.min(-11.5 + c3s/150, 1) });

  $('.project3description').css({ 'opacity' : Math.min(-9.3 + c3s/170, 1) });
